<div style="padding: 20px">
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Codeudor #1</h3>
                </div>
                <div class="box-body">

                    <p class="text-muted">
                        <i class="fa fa-user" style="color: #000;"></i> <?= $model->nombre_codeudor_1; ?>
                        <br />
                        <i class="fa fa-phone" style="color: #000;"></i> <?= $model->documento_codeudor_1; ?>
                        <br />
                        <i class="fa fa-phone" style="color: #000;"></i> <?= $model->direccion_codeudor_1; ?>
                        <br />
                        <i class="fa fa-phone" style="color: #000;"></i> <?= $model->telefono_codeudor_1; ?>
                        <br />
                        <i class="fa fa-envelope" style="color: #000;"></i> <?= $model->email_codeudor_1; ?>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <p class="text-muted">
                        <i class="fa fa-user" style="color: #000;"></i> <?= $model->nombre_codeudor_2; ?>
                        <br />
                        <i class="fa fa-phone" style="color: #000;"></i> <?= $model->documento_codeudor_2; ?>
                        <br />
                        <i class="fa fa-phone" style="color: #000;"></i> <?= $model->direccion_codeudor_2; ?>
                        <br />
                        <i class="fa fa-phone" style="color: #000;"></i> <?= $model->telefonol_codeudor_2; ?>
                        <br />
                        <i class="fa fa-envelope" style="color: #000;"></i> <?= $model->email_codeudor_2; ?>
                    </p>
                </div>
            </div>
        </div>
