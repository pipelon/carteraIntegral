...
class TipoProcesosController extends Controller {
    ...
    public function actionCreate() {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            //LOG
            $mensaje = "El tipo de proceso '{$model->nombre}' ha sido creado.";
    ...
    public function actionUpdate($id) {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            //LOG
            $mensaje = "El tipo de proceso #'{$id}' ha sido editado.";
            \Yii::info($mensaje, "cartera");
            return $this->redirect(['view', 'id' => $model->id]);
        } else {
    ...
    public function actionDelete($id) {
        ...
        //LOG
        $mensaje = "El tipo de proceso '{$model->nombre}' ha sido eliminado.";
        \Yii::info($mensaje, "cartera");
