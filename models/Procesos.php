...
class Procesos extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            ...
            'jur_fecha_gestion_juridica', 'prejur_estudio_bienes', 'modified', 'file', 'jur_etapas_procesal_medidas_cautelares_comentarios'], 'safe'],
    ...
    public function attributeLabels() {
        return [
            ...
            'jur_etapas_procesal_medidas_cautelares_comentarios' => 'Comentario medidas cautelares',
