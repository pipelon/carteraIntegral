...
/**
 * This is the model class for table "etapas_procesales_medidas_cautelares".
 *
 * @property int $id ID
 ...
 */
class EtapasProcesalesMedidasCautelares extends BeforeModel {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'etapas_procesales_medidas_cautelares';
    }
    ...
    public function getProcesos() {
        return $this->hasMany(Procesos::className(), ['jur_etapas_procesal_medidas_cautelares_id' => 'id']);
    }
