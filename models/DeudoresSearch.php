...
class DeudoresSearch extends Deudores {
    ...
    public function rules() {
        return [
            ...
            'direccion_codeudor_1', 'email_codeudor_1',
            'telefono_codeudor_1', 'nombre_codeudor_2',
            'documento_codeudor_2', 'direccion_codeudor_2',
            'email_codeudor_2', 'telefonol_codeudor_2', 'comentarios',
