...
/**
 * This is the model class for table "etapas_procesales_cuaderno_ppal".
 *
 * @property int $id ID
 ...
 */
class EtapasProcesalesCuadernoPpal extends BeforeModel {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'etapas_procesales_cuaderno_ppal';
    }
    ...
    public function getProcesos() {
        return $this->hasMany(Procesos::className(), ['jur_etapas_procesal_cuaderno_ppal_id' => 'id']);
    }
