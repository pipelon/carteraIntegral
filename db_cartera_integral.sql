...
insert  into `bienes_x_proceso`(`id`,`proceso_id`,`bien_id`,`comentario`) values (11,4,1,'Inmuebles'),(12,4,4,'Comentario 22222'),(13,4,5,'Comentario 33333');
...
insert  into `procesos`(`id`,`cliente_id`,`deudor_id`,`prejur_fecha_recepcion`,`prejur_tipo_caso`,`prejur_consulta_rama_judicial`,`prejur_consulta_entidad_reguladora`,`prejur_concepto_viabilidad`,`prejur_otros`) values (2,1,2,NULL,NULL,NULL,NULL,NULL,NULL),(3,93,3,'2021-07-15',1,NULL,NULL,NULL,NULL),(4,1,3,NULL,NULL,'','','','');
...
insert  into `procesos_x_colaboradores`(`id`,`proceso_id`,`user_id`) values (18,2,7),(19,2,8),(20,2,10),(37,3,7),(38,3,8),(39,3,10),(52,4,7),(53,4,8),(54,4,10);
