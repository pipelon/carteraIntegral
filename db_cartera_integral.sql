...
insert  into `bienes_x_proceso`(`id`,`proceso_id`,`bien_id`,`comentario`) values (145,9,1,'PRUEBA INMUEBLE 13'),(146,9,3,'PRUEBA CRE'),(147,9,6,'PRUEBA ESTABLECIMIENTO 14');
...
insert  into `consolidado_pagos_juridicos`(`id`,`proceso_id`,`valor_pago`,`fecha_pago`) values (40,9,'1234.56','2021-08-14 00:00:00'),(41,9,'6789.02','2021-08-12 00:00:00');
...
insert  into `docactivacion_x_proceso`(`id`,`proceso_id`,`documento_activacion_id`) values (106,9,1),(107,9,2),(108,9,3);
...
insert  into `procesos_x_colaboradores`(`id`,`proceso_id`,`user_id`) values (285,9,7),(286,9,8),(287,9,10);
