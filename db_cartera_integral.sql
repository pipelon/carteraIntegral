...
insert  into `consolidado_pagos_juridicos`(`id`,`proceso_id`,`valor_pago`,`fecha_pago`) values (1,9,'1.00','2021-08-14 00:00:00'),(2,9,'2.00','2021-08-13 00:00:00'),(16,21,'1.00','2021-08-14 00:00:00'),(17,21,'2.00','2021-08-13 00:00:00');
...
insert  into `docactivacion_x_proceso`(`id`,`proceso_id`,`documento_activacion_id`) values (19,11,1),(20,11,2),(21,11,8),(70,9,1),(71,9,2),(72,9,3);
...
insert  into `menu`(`id`,`name`,`parent`,`route`,`order`,`data`) values (1,'Configuración',NULL,NULL,3,' flaticon-cogwheel'),(2,'Asignaciones',1,'/admin/assignment/index',2,' flaticon-user-ok'),(3,'Usuarios',1,'/users/index',1,' flaticon-users'),(4,'General',NULL,NULL,2,' flaticon-add'),(5,'Tipos de procesos',4,'/tipo-procesos/index',4,' flaticon-list-3'),(9,'Clientes',4,'/clientes/index',1,' flaticon-users'),(10,'Deudores',4,'/deudores/index',2,' flaticon-coins'),(11,'Procesos',NULL,'/procesos/index',1,' flaticon-list-2'),(12,'Tipo de casos',4,'/tipo-casos/index',5,' flaticon-list-3'),(13,'Bienes',4,'/bienes/index',6,' flaticon-list-3'),(14,'Doc. activación',4,'/documentos-activacion/index',7,' flaticon-list-3'),(15,'Etapas procesales',4,'/etapas-procesales/index',8,' flaticon-list-3');
