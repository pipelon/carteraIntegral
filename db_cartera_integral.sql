...
CREATE TABLE `gestiones_prejuridicas` (
  ...
  `usuario_gestion` varchar(100) DEFAULT NULL COMMENT 'Usuario de gestión',
  `descripcion_gestion` date DEFAULT NULL COMMENT 'Descripción gestión',
  PRIMARY KEY (`id`),
...
insert  into `menu`(`id`,`name`,`parent`,`route`,`order`,`data`) values (1,'Configuración',NULL,NULL,3,' flaticon-cogwheel'),(2,'Asignaciones',1,'/admin/assignment/index',2,' flaticon-user-ok'),(3,'Usuarios',1,'/users/index',1,' flaticon-users'),(4,'General',NULL,NULL,2,' flaticon-add'),(5,'Tipos de procesos',4,'/tipo-procesos/index',4,' flaticon-squares-2'),(6,'Informes',NULL,NULL,1,' flaticon-statistics'),(7,'Informe',6,'/report-temp/index',1,' flaticon-interface-6'),(9,'Clientes',4,'/clientes/index',1,' flaticon-users'),(10,'Deudores',4,'/deudores/index',2,' flaticon-coins'),(11,'Procesos',NULL,'/procesos/index',1,' flaticon-list-2'),(12,'Tipo de casos',4,'/tipo-casos/index',5,' flaticon-squares-2');
...
CREATE TABLE `procesos` (
  ...
  `prejur_estudio_bienes` varchar(45) DEFAULT NULL COMMENT 'Estudio de bienes',
...
insert  into `procesos`(`id`,`cliente_id`,`deudor_id`,`prejur_fecha_recepcion`,`prejur_tipo_caso`,`prejur_consulta_rama_judicial`,`prejur_consulta_entidad_reguladora`,`prejur_estudio_bienes`,`prejur_concepto_viabilidad`,`prejur_otros`) values (2,1,2,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(3,93,3,'2021-07-15',1,NULL,NULL,NULL,NULL,NULL);
...
insert  into `procesos_x_colaboradores`(`id`,`proceso_id`,`user_id`) values (18,2,7),(19,2,8),(20,2,10),(37,3,7),(38,3,8),(39,3,10);
...
insert  into `tipo_casos`(`id`,`nombre`,`activo`,`created`,`created_by`,`modified`,`modified_by`) values (1,'PREJURíDICO',1,'2021-07-20 09:34:12','admin','2021-07-20 09:34:12','admin'),(2,'DEMANDA',1,'2021-07-20 09:34:27','admin','2021-07-20 09:34:27','admin'),(3,'CONCILIACIÓN',1,'2021-07-20 09:34:41','admin','2021-07-20 09:34:41','admin'),(4,'LEY 1116',1,'2021-07-20 09:34:50','admin','2021-07-20 09:34:50','admin'),(5,'LIQUIDACIÓN',1,'2021-07-20 09:34:59','admin','2021-07-20 09:35:35','admin'),(6,'CARTERA CORRIENTE',1,'2021-07-20 09:35:07','admin','2021-07-20 09:35:07','admin'),(7,'OTROS',1,'2021-07-20 09:35:12','admin','2021-07-20 09:35:12','admin');
