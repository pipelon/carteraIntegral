...
insert  into `auth_assignment`(`item_name`,`user_id`,`created_at`) values ('Colaboradores','10',1626291347),('Colaboradores','8',1626290925),('Colaboradores','9',1626290913),('Jefes','7',1629836788),('SuperAdministrador','6',1621801416);
...
insert  into `docactivacion_x_proceso`(`id`,`proceso_id`,`documento_activacion_id`) values (215,9,1),(216,9,2);
...
CREATE TABLE `procesos` (
  ...
  `jefe_id` int(11) NOT NULL COMMENT 'Jefe',
  ...
  KEY `fk_procesos_users_idx` (`jefe_id`),
